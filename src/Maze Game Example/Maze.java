...
public class Maze extends JFrame {
        ...
        this.addKeyListener(new KeyListener(){
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if(p.x == columns-1 && p.y == endLevelLoc){
                    JOptionPane.showMessageDialog(null, "Congratulations, you passed the level!", "End Game", JOptionPane.INFORMATION_MESSAGE);
                    dispose();
                    new MainMenu();
                }
            }
    ...
    public void loadMap(String str){
        try{
            ...
            System.out.println("Cannot load existing map (if exists), create a new map.");
        }
    }
}